                    ...
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <img alt="Category image" class="rounded-md" src="<?php echo e(Str::startsWith($astroCat->image, ['http://','https://']) ? $astroCat->image : '/' . $astroCat->image); ?>"
                                    onerror="this.src='/build/assets/images/person.png'">
                                <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                                    <a href="javascript:;" class="block font-medium text-base"><?php echo e($astroCat['name']); ?></a>
                                </div>
                            </div>
                        </div>
                        <div
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('editPujaCategory')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="p-5">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <form action="<?php echo e(route('PujaCategoryStatus')); ?>" method="POST"
...
<script type="module">
    ...
    jQuery("#add-data").submit(function(e) {
        ...
        jQuery.ajax({
            type: 'POST',
            url: "<?php echo e(route('addPujaCategory')); ?>",
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\astroway\Website\resources\views/pages/puja-category.blade.php ENDPATH**/ ?>