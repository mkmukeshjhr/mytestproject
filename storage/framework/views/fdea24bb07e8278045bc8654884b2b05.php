...
<head>
    ...
    <title><?php echo e(ucfirst($professionTitle)); ?> Login</title>
    <link rel="icon" href="/<?php echo e($logo['value']); ?>" type="image/x-icon">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <meta
        content="Ask an online <?php echo e($professionTitle); ?> and get instant consultation on top Astrology portal. Accurate astrology predictions and solutions by India's best <?php echo e($professionTitle); ?>s' team."
        name="description" />
    ...
    <meta name="twitter:title"
        content="Online Astrology Consultation, Ask an <?php echo e(ucfirst($professionTitle)); ?> - <?php echo e(ucfirst($appname)); ?>" />
    ...
    <title>Online Astrology Consultation, Ask an <?php echo e(ucfirst($professionTitle)); ?> - <?php echo e(ucfirst($appname)); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/newcss.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/app.min.css')); ?>">
    ...
    <link href="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/css/font/stylesheet.css')); ?>"
        rel="stylesheet" />
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/css/carousel/owl.carousel.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/css/carousel/owl.carousel.css')); ?>">
    <link href="<?php echo e(asset('frontend/select2/npm/select2@4.1.0-rc.0/dist/css/select2.min.css')); ?>"
        rel="stylesheet" />
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="login-offer-bg">
                        <p class="text-white font-22 text-center font-weight-bold p-0 m-0 offertxt1">
                            <img src="<?php echo e(asset($logo->value)); ?>" alt="<?php echo e($appName->value); ?>" class="img-fluid mb-2 mr-3" width="60" height="60"> Give Consultation to Users</p>
                    </div>
                    <div class="bg-white p-4 shadow-sm" style="border: 1px solid #ddd;border-bottom-left-radius:10px;border-bottom-right-radius:10px">
                        ...
                        <div class="text-center font-22 d-flex align-items-center justify-content-center">
                            ...
                            <h3 class="font-weight-bold mb-0 mt-2 mb-3"><?php echo e(ucfirst($professionTitle)); ?> Sign In</h3>
                        </div>
                        <div>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="d-flex inputform country-dropdown-container p-1" style="border: 1px solid #ddd; border-radius: 4px; overflow: hidden;" id="header-country-dropdown-container">
                                        ...
                                        <select class="form-control select2" id="countryCode" name="countryCode" style="border: none; border-right: 1px solid #ddd; border-radius: 0; width: 20%;">
                                            ...
                                            <option data-country="in" value="+<?php echo e($country->phonecode); ?>" data-ucname="India">+<?php echo e($country->phonecode); ?> <?php echo e($country->iso); ?></option>
                            ...
                            <div class="col-md-11 list-inline-item ml-md-3 ml-sm-0">
                                <p class="text-dark font-13 text-center pb-md-0 pb-2 mb-0">
                                    By signing in, you agree to our&nbsp;<a class="text-dark font-13"
                                        ...
                                        href="<?php echo e(route('front.astrologerTermsCondition')); ?>" target="_blank">Terms Of
                                        Use</a>&nbsp;and&nbsp;<a class="text-dark font-13"
                                        style="color:#EE4E5E !important"
                                        href="<?php echo e(route('front.astrologerPrivacyPolicy')); ?>" target="_blank">Privacy
                                        Policy</a>
                                </p>
                            </div>
                        </div>
...
<script
    src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/carousel/owl.carousel.min.js')); ?>">
</script>
<script src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/carousel/owl.carousel.js')); ?>">
</script>
<script src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/popper.min.js')); ?>"></script>


<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/lottie-web/5.12.2/lottie.min.js"></script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/bootstrap.min.js')); ?>">
</script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/popper.min.js')); ?>">
</script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/js/momentum.js')); ?>"></script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/js/bootstrap-datepicker.min.js')); ?>">
</script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/js/js.cookie.min.js')); ?>"></script>
<script async src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/bundle/js/AfterLoginJs.js')); ?>">
</script>
...
<script src="<?php echo e(asset('frontend/astrowaycdn/dashaspeaks/web/content/astroway/js/duDatepicker.js')); ?>"></script>
...
<script>
    $(document).ready(function() {
        ...
        $('#verifyOtpBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo e(route("front.verifyOTLAstro")); ?>',
                method: 'POST',
                data: {
                    contactNo: mobile,
                    otp: otpCode,
...
</script><?php /**PATH G:\xampp\htdocs\astroway\Website\resources\views/frontend/astrologers/pages/astrologers-login.blade.php ENDPATH**/ ?>