                    ...
                    <div class="owl-carousel owl-theme owl-blur owl-mobile">
                        @foreach ($liveAstrologer as $live)
                            <div class="item gif-animation-enable mb-3"
                                ...
                                <a @if(authcheck()) href="{{ route('front.LiveAstroDetails', ['astrologerId' => $live->astrologerId]) }}" @else data-toggle="modal" data-target="#loginSignUp" @endif"
                                    class="text-white">
...
<!-- ================= HOROSCOPE SECTION END ================= -->
    ...
    @if (!empty($astrologyVideo) && count($astrologyVideo))
        <section class="py-5 bg-white" id="calculator" style="background:url('{{ asset('frontend/homeimage/videobackground.jpeg') }}');">
            ...
            <div class="container-fluid">
                ...
                <div class="marquee-wrapper overflow-hidden position-relative">
                    <div class="marquee d-flex">
                        ...
                        @foreach (collect($astrologyVideo)->concat($astrologyVideo) as $video)
                            ...
                            data-target="#videoModal">
                                ...
                                <div class="video-card position-relative">
                                    <img
                                        ...
                                        loading="lazy"
                                        onerror="this.onerror=null;this.src='{{ asset('build/assets/images/person.png') }}';"
                                    />

                                    <img
                                        class="position-absolute youtube-icon"
                                        style="cursor:pointer"
                                        src="{{ asset('frontend/homeimage/youtube.svg') }}"
                                        alt="YouTube"
                                    />
                        ...
                        <div class="vedic-card"
                            ...
                            <span class="vedic-product-img"
                                ...
                                <img
                                    ...
                                    loading="lazy"
                                    onerror="this.onerror=null;this.src='{{ asset('build/assets/images/person.png') }}';"
                                    onclick="openImage('{{ $product->profile_image_url }}')"
                                />
                            </span>
                            ...
                            <div class="vedic-product-footer">
                                <p class="vedic-price mb-3">
                                    ...
                                    @if ($walletType === 'coin')
                                        <img src="{{ asset($coinIcon) }}" alt="Coin" width="15">
                                    @else
                                        {{ $currency['value'] }}
                                    @endif
                                ...
                                <a href="{{ route('front.getproductDetails', $product->slug) }}"
    ...
    @if (!empty($astrotalkInNews) && count($astrotalkInNews))
            ...
            <div class="row justify-content-strat">
                    ...
                    @foreach ($blog as $bloglist)
                        <div class="col-md-4 mt-4">
                            <a href="{{ route('front.getBlogDetails', $bloglist->slug) }}"
                                ...
                                <div class="product-card parad-shivling shadow-sm overflow-hidden p-0">
                                    <div class="position-relative" style="height:250px;">
                                        <img
                                            ...
                                            src="{{ $bloglist->blog_image_url }}"
                                            alt="{{ $bloglist->title }}"
                                            loading="lazy"
                                            onerror="this.onerror=null;this.src='{{ asset('build/assets/images/person.png') }}';"
                                            onclick="openImage('{{ $bloglist->blog_image_url }}')"
                                        />
                                    </div>
