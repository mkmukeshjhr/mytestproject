                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle font-weight-semi-bold nav-link-mobile" href="#"
                            ...
                            aria-expanded="false">
                            <img src="/{{ $freekundali->value }}" alt="" height="20" width="20">
                            Kundali
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.getPanchang') }}"><img src="/{{ $panchang->value }}"
                                alt="" height="20" width="20"> Panchang</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.pujaCategory') }}"><img src="/{{ $puja->value }}" alt=""
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.horoScope') }}"><img src="/{{ $daily_horoscope->value }}"
                                alt="" height="20" width="20"> Horoscope</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.getproducts') }}"><img src="/{{ $shop->value }}" alt=""
                                height="20" width="20"> Shop</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link font-weight-semi-bold nav-link-mobile"
                            href="{{ route('front.getBlog') }}"><img src="/{{ $blog->value }}" alt=""
